...
PRESTO_PORT=$(find_free_port "${AIRLAYER_PRESTO_PORT:-18080}")
...
AIRLAYER_PRESTO_PORT=$PRESTO_PORT
EOF

echo "Ports: pg=$PG_PORT mysql=$MYSQL_PORT clickhouse=$CH_HTTP_PORT presto=$PRESTO_PORT"
...
export AIRLAYER_PRESTO_PORT=$PRESTO_PORT
