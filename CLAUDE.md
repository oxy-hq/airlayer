...
886 lib tests (`cargo test --lib -- --list`: 884 pass + 2 ignored) = Unit tests (417) + Preagg unit tests (180) + Metric tree ops (289); the Peer cohorts row is a subset of Unit tests, not additional. The ~1,043 total above adds the four integration/contrib rows (66 + 40 + 21 + 30 = 157) on top of the 886 lib tests.
