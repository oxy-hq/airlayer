...
882 lib tests (`cargo test --lib -- --list`: 880 pass + 2 ignored) = Unit tests (413) + Preagg unit tests (180) + Metric tree ops (289); the Peer cohorts row is a subset of Unit tests, not additional. The ~1,039 total above adds the four integration/contrib rows (66 + 40 + 21 + 30 = 157) on top of the 882 lib tests.
